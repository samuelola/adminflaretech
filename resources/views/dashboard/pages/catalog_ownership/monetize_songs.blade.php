                        ...
                        <div class="form-step active">
                           ...
                           <form id="step1Form" enctype="multipart/form-data">
                             ...
                             <div class="step-title mb-3" style="font-weight: 600;">Artist Identity</div>
                                      ...
                                      <input type="file" class="form-control" name="government_id">
                                        @if(!empty($artist->government_id_path))
                                                ...
                                                @php
                                                    ...
                                                    $storageUrl = rtrim(config('external_link.services.website_storage_link'), '/');
                                                @endphp
                              ...
                              <button type="submit" class="btn btn-primary-600 mt-3 disabled" id="step1Submit">Save & Continue</button>
        ...
        <img id="uploadedIDImage" src="" alt="Government ID" class="img-fluid">
                        ...
                        <div class="form-step">
                              ...
                              <div id="coOwnershipSection" style="display:none;">
                                  ...
                                  <button type="button" class="btn btn-outline-primary-600 mt-2 disabled" id="addHolder">
                                  Add Rights Holder
                                  </button>

                              </div>

                                  <button type="submit" id="step2Submit" class="btn btn-primary-600 mt-3 disabled">Save & Continue</button>
                          ...
                          <div class="form-step">
                           ...
                           <form id="step3Form" enctype="multipart/form-data">
                            ...
                            <div id="songsContainer">
                                ...
                                <button type="submit" id="step3Submit" class="btn btn-primary-600 disabled">Save & Continue</button>
                                ...
                                <form id="step4Form">
                                    ...
                                    <div id="step4SongsContainer">
                                        ...
                                        <div class="song-contributors-block mb-4 border p-3">
                                            ...
                                            <button type="button" class="btn btn-outline-primary-600 addContributorBtn disabled">Add Contributor</button>
                                    ...
                                    <button type="button" class="btn btn-primary-600 mt-3 disabled" id="step4Submit">Save & Continue</button>
                                </form>
                          ...
                          <div class="form-step">
                              ...
                              <form id="step5Form">
                                    ...
                                    <button type="submit" class="btn btn-primary-600 mt-3 disabled" id="step5Submit">Save & Continue</button>
                                </form>
                        ...
                        <div class="form-step">
                           ...
                           <form id="step6Form">
                              ...
                              <button type="submit" class="btn btn-primary-600 mt-3 disabled">Save & Continue</button>
        ...
        for(let i = 0; i < files.length; i++){
            ...
            let html = `
                <div class="song-block mb-4 border p-3 mt-3" data-index="${currentIndex}">
                    ...
                    <button type="button" class="btn btn-danger remove-song mt-3 disabled">
                        Remove
                    </button>
    ...
    $(document).on('click', '.addContributorBtn', function(){
        ...
        tbody.append(`
            <tr>
                ...
                <td><button type="button" class="btn btn-danger removeContributor disabled">X</button></td>
            </tr>
        `);
    });
...
<div class="col-md-1">
    <button type="button" class="btn btn-danger removeHolder disabled">X</button>
</div>
